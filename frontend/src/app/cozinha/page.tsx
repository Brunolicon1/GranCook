          ...
          <div className="flex-1 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-slate-700">
            ...
            <div className="columns-1 md:columns-2 lg:columns-3 xl:columns-4 gap-6 space-y-6">
              {ticketsAtivos.map(ticket => (
                <div key={`${ticket.comanda_id}-${ticket.hora_pedido}`} className={`relative flex flex-col justify-between p-5 rounded-2xl border backdrop-blur-md transition-all duration-300 break-inside-avoid ${getCardStyles(ticket.tempo_decorrido_minutos)}`}>
